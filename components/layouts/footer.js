        ...
        <div className="grid gap-[24px]">
          ...
          <ul className="grid gap-[16px]">
            <li className="text-[17px] font-medium flex items-center gap-2">
                <Link href='https://www.facebook.com/MakarioWorks/' target="_blank" className="flex items-center gap-[8px]">
            ...
            <li className="text-[17px] font-medium flex items-center gap-2">
                <Link href='https://x.com/makarioworks' target="_blank" className="flex items-center gap-[8px]">
            ...
            <li className="text-[17px] font-medium flex items-center gap-2">
                <Link href='https://www.instagram.com/makarioworks?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==' target="_blank" className="flex items-center gap-[8px]">
        ...
        <div className="grid gap-[24px]">
          ...
          <ul className="grid gap-[16px]">
            <li className="text-[17px] font-medium flex items-center gap-2">
              ...
              <Link href="mailto:info@makarioworks.com" target="_blank">info@makarioworks.com</Link>
            </li>
            <li className="text-[17px] font-medium flex items-center gap-2">
              ...
              <Link href="tel:+2348037079950">0803 707 9950</Link>
            </li>
          </ul>
        </div>
      </div>
