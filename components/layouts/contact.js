        ...
        <div className="grid lg:grid-flow-col justify-between items-center gap-[50px] content-center py-[80px] lg:py-[120px] mb-[40px] lg:mb-0 lg:px-[120px] max-w-[90%] lg:max-w-[1440px] m-auto">
            <div className="grid gap-[40px] max-w-[540px]">
                <div className="grid gap-[5px] lg:gap-[30px]">
                    ...
                    <p className="max-w-[580px] text-[27px] lg:text-[56px] text-[#1e1d1d] font-bold leading-[48px]">Ready to enhance your security?</p>
                    ...
                    <div className="grid grid-flow-col justify-start gap-[35px] items-center mt-[10px] lg:mt-0">
                        <PrimartButton href='/contact' style='text-white '>Contact US</PrimartButton>
                        <div className="grid grid-flow-col gap-[8px] items-center">
                            ...
                            <Link href='tex:+2348037079950' className="text-[18px] text-[#1e1d1d] font-medium">0803 707 9950</Link>
                        </div>
                    </div>
                </div>
            </div>
