...
const AboutSection = () =>{
    return(
        <div className="max-w-[90%] lg:max-w-[1440px] m-auto lg:px-[120px] py-[100px] grid gap-[100px]">
            <div className="grid lg:grid-flow-col items-start content-start justify-between">
                <Image
                ...
                <div className="grid gap-[30px] max-w-[560px]">
                    ...
                    <p className="max-w-[580px] text-[36px] lg:text-[56px] text-[#1e1d1d] font-bold leading-[48px]">Makario Technology Solutions Company</p>
            ...
            <div className="grid grid-flow-col justify-between gap-[24px] items-center">
                <div className="grid content-between gap-[32px]">
                    <div className="grid grid-flow-col items-start justify-between pb-[32px] border-b-[1px]">
                        <p className="max-w-[580px] text-[36px] lg:text-[56px] text-[#1e1d1d] font-bold leading-[48px]">Energy <br/> Efficiency</p>
                ...
                <div className="grid content-between gap-[32px]">
                    <div className="grid grid-flow-col items-start justify-between pb-[32px] border-b-[1px]">
                        <p className="max-w-[580px] text-[36px] lg:text-[56px] text-[#1e1d1d] font-bold leading-[48px]">Minimal <br/> Impact</p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"><path fill="none" stroke="#1e1d1d" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 7L7 17M8 7h9v9"/></svg>
                    </div>
                    <p className="text-[16px] text-[#61666f]">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam. </p>
                </div>
                <div className="grid content-between gap-[32px]">
                    <div className="grid grid-flow-col items-start justify-between pb-[32px] border-b-[1px]">
                        <p className="max-w-[580px] text-[36px] lg:text-[56px] text-[#1e1d1d] font-bold leading-[48px]">Low-Risk <br/> Investment</p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"><path fill="none" stroke="#1e1d1d" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 7L7 17M8 7h9v9"/></svg>
                    </div>
                    <p className="text-[16px] text-[#61666f]">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam. </p>
                </div>
