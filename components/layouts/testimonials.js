...
const Testimonials = () => {
  ...
  return (
    <div className="bg-black py-[120px] justify-center content-center mb-[100px]">
      <div className="mb-[45px] m-auto text-center grid gap-[20px]">
        <p className="text-[14px] text-[#fcfcfc] tracking-[3px] font-medium">Testimonials</p>
        <h2 className="text-[27px] lg:text-[56px] text-center font-bold leading-[48px] text-[#fcfcfc]">Satisfied clients</h2>
      </div>
      <Slider {...settings}>
            ...
            <div className="group bg-[#1e1d1d] p-[45px] shadow-md grid gap-[32px] min-h-[400px] content-between gap-[32px] mb-[25px]">
              ...
              <div className="grid grid-flow-col items-center gap-[20px] justify-start">
                <div className="w-[70px] h-[70px] rounded-full bg-[#fcfcfc] grid items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24"><g fill="none" stroke="black" stroke-width="1.5"><path stroke-linejoin="round" d="M4 18a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2Z" /><circle cx="12" cy="7" r="3" /></g></svg>
                </div>
                <div className="grid gap-[6px]">
                  <p className="text-[15px] text-[#fcfcfc] font-semibold">{testimonial.name}</p>
                  <p className="text-[#9f9f9f] text-[15px] font-medium">{testimonial.role}</p>
                </div>
              </div>
            </div>
          </div>
