const servicesArray = [
    {
        ...
        description: "We provide comprehensive procurement and installation services for CCTV and access control systems for homes, offices, warehouses, and remote farms. Our systems offer remote access through the internet and local networks, ensuring security and monitoring capabilities at all times.",
        svg: `<svg xmlns="http://www.w3.org/2000/svg" width="75px" height="75px" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M3 4a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1zm5 10a4 4 0 1 0 8 0a4 4 0 1 0-8 0" /><path d="M19 7v7a7 7 0 0 1-14 0V7m7 7h.01" /></g></svg>`,
        image: "camera2.png"
    },
    {
        id: 2,
        title: "Networking Solutions",
        description: "From wired and wireless networking setups to servers and routers, we handle complete office setups for PCs and laptops. Whether your organization needs small-scale solutions or complex networks, we ensure seamless connectivity and performance.",
    ...
    },
    {
        ...
        description: "Our team is skilled in the procurement, installation, and maintenance of solar power solutions for homes, offices, farms, and industries. We aim to provide reliable, cost-effective, and sustainable energy options.",
    ...
    },
    {
        ...
        description: "Safety is paramount, and we offer installation services for 2-zone and 4-zone fire alarm systems, complete with smoke detectors and sirens for homes, offices, and other facilities.",
    ...
    },
    {
        id: 5,
        title: "Sound Systems",
        description: "Enhance your environment with high-quality sound systems tailored to your needs, whether for office spaces, entertainment areas, or event venues.",
    ...
    {
        id: 6,
        title: "Smart Door Locks and Access Control",
        description: "We offer a range of smart door locks and time attendance systems to enhance security and convenience for residential and commercial properties.",
    ...
    },
    {
        ...
        description: "Whether you're a homeowner looking for a basic intercom system or a business in need of a sophisticated multi-zone solution, we design, procure, and install systems that meet your needs.",
        svg: `<svg xmlns="http://www.w3.org/2000/svg" width="75px" height="75px" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L2 7v15h8V14h4v8h8V7L12 2zM4 20v-9.5l8-4.5 8 4.5V20h-6v-6H10v6H4z" /><path d="M10 10h4v2h-4z" /><path d="M6 12h2v2H6z" /><path d="M16 12h2v2h-2z" /><path d="M6 16h2v2H6z" /><path d="M16 16h2v2h-2z" /></svg>`,
        image: "camera2.png"
    }
];
