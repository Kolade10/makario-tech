...
const Socials = () => {
    return (
        <div className='grid grid-flow-col items-center justify-start gap-[30px]'>
            <Link href='tel:+2348037079950' className='text-[#1e1d1d] hover:text-[#337ab7] transition-all duration-500'>
            ...
            <Link href='https://wa.link/0efijc' target='_blank' className='text-[#1e1d1d] hover:text-[#337ab7] transition-all duration-500'>
            ...
            <Link href="https://www.instagram.com/makarioworks/?hl=en" target='_blank' className='text-[#1e1d1d] hover:text-[#337ab7] transition-all duration-500'>
            ...
            <Link href="mailto:info@makarioworks.com" target='_blank' className='text-[#1e1d1d] hover:text-[#337ab7] transition-all duration-500'>
